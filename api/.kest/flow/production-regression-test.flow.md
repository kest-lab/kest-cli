# 🔄 Production API Regression Test

Test the production API at https://api.kest.dev to verify all documented endpoints.
...
```kest
POST https://api.kest.dev/register
...
```kest
POST https://api.kest.dev/projects
...
```kest
GET https://api.kest.dev/projects
Authorization: Bearer {{access_token}}
...
```kest
GET https://api.kest.dev/projects/{{project_id}}
Authorization: Bearer {{access_token}}
...
```kest
GET https://api.kest.dev/projects/{{project_id}}/dsn
Authorization: Bearer {{access_token}}
...
```kest
PUT https://api.kest.dev/projects/{{project_id}}
Authorization: Bearer {{access_token}}
Content-Type: application/json
...
```kest
GET https://api.kest.dev/users/profile
Authorization: Bearer {{access_token}}
...
```kest
PUT https://api.kest.dev/users/profile
Authorization: Bearer {{access_token}}
Content-Type: application/json
...
## Step 11: Test API Specifications (if available)

```kest
GET https://api.kest.dev/projects/{{project_id}}/api-specs
Authorization: Bearer {{access_token}}
...
## Step 12: Test Environments (if available)

```kest
GET https://api.kest.dev/projects/{{project_id}}/environments
Authorization: Bearer {{access_token}}
...
## Step 13: Test Test Cases (if available)

```kest
GET https://api.kest.dev/projects/{{project_id}}/test-cases
Authorization: Bearer {{access_token}}
...
## Step 14: Test Categories (if available)

```kest
GET https://api.kest.dev/projects/{{project_id}}/categories
Authorization: Bearer {{access_token}}
...
## Step 15: Test Members (if available)

```kest
GET https://api.kest.dev/projects/{{project_id}}/members
Authorization: Bearer {{access_token}}
...
## Step 16: Test Permissions (if available)

```kest
GET https://api.kest.dev/projects/{{project_id}}/permissions
Authorization: Bearer {{access_token}}
...
## Step 17: Test Issues (if available)

```kest
GET https://api.kest.dev/projects/{{project_id}}/issues
Authorization: Bearer {{access_token}}
...
```kest
GET https://api.kest.dev/system/info
Authorization: Bearer {{access_token}}
...
```kest
DELETE https://api.kest.dev/projects/{{project_id}}
Authorization: Bearer {{access_token}}
...
```kest
DELETE https://api.kest.dev/users/account
Authorization: Bearer {{access_token}}
