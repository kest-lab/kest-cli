...
export const environmentApi = {
     ...
     * Create environment
     */
    create: (projectId: number, data: Omit<CreateEnvironmentRequest, 'project_id'>) =>
        request.post<Environment>(`/v1/projects/${projectId}/environments`, data),

    /**
     * Update environment
     */
    update: (projectId: number, id: number, data: Partial<Omit<CreateEnvironmentRequest, 'project_id'>>) =>
