  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {!hideCloseButton && (
          <DialogPrimitive.Close className="absolute right-3 top-3 flex size-9 cursor-pointer items-center justify-center rounded-full border border-border-main bg-bg-canvas text-muted-foreground transition-colors hover:text-foreground focus-ring disabled:cursor-not-allowed disabled:opacity-50">
            <X className="size-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-medium leading-[1.4] tracking-normal text-foreground",
      className
    )}
    {...props}
  />
