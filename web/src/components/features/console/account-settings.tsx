  ...
  return (
    <div className="flex-1 space-y-6 p-6 pt-6">
      <div className="space-y-1">
        <h1 className="text-3xl font-medium tracking-normal">{t.console('account.title')}</h1>
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-sm">
            <div className="flex items-center justify-between rounded-xl border border-border-subtle bg-bg-soft p-3">
