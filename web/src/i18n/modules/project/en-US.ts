...
const messages: ProjectMessages = {
  ...
  history: {
    ...
    runs: {
      title: 'Runs',
      description: 'Inspect structured execution records captured across the workspace.',
      projectRuns: 'Workspace runs',
      searchPlaceholder: 'Search runs',
      filterBySourceType: 'Filter by source type',
      filterByStatus: 'Filter by status',
      allSourceTypes: 'All source types',
      allStatuses: 'All statuses',
      noMatchingRuns: 'No matching runs',
      noRunsYet: 'No runs yet',
      noMatchingDescription: 'Try a different keyword, source type, or status filter.',
      emptyDescription: 'Run records will appear here once saved requests, collections, tests, or flows are executed.',
      currentDescriptionWithSelection: 'Run detail loaded from the selected workspace-scoped execution record.',
      currentDescriptionEmpty: 'Select a run in the sidebar to inspect persisted execution details and step snapshots.',
      noMatchingRecord: 'No matching run record',
      noRunRecorded: 'No run recorded',
      noMatchingRecordDescription:
        'No run records matched the current filters. Clear the filter or broaden your search.',
      noRunRecordedDescription: 'This workspace does not have any persisted run records yet.',
      chooseRecord: 'Choose a run',
      chooseRecordDescription:
        'The content area stays focused on a single run. Pick one from the sidebar to inspect the stored execution detail.',
      listDescription: '{sourceType} run · {executionMode}',
      detailDescription: 'Structured execution detail recorded for this {sourceType} run.',
      metadata: 'Run metadata',
      metadataDescription: 'Core fields captured for the selected run record.',
      recordId: 'Run ID',
      ...
      recordedNote: 'Error summary',
      recordedNoteDescription: 'Top-level failure or error information recorded for this run.',
      noErrorRecorded: 'No error summary recorded.',
      metadataJson: 'Run metadata JSON',
      stepResults: 'Run steps',
      stepResultsDescription: 'Per-step execution results persisted for this run.',
      ...
      stepLabel: 'Step {index} · {sourceType}',
  ...
  collections: {
    ...
    workbench: {
      ...
      runs: {
        title: 'Unified Runs',
        description: '{sourceType} runs recorded for {sourceName}.',
        totalRuns: 'Runs',
        historyRelation:
          'Runs are the execution record for request and collection runs. History remains the audit trail for broader workspace activity.',
